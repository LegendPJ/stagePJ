jQuery(function($) {
	tinyMCE.init({
		...
		skin : 'o2k7',
	   	skin_variant : 'silver',
		plugins : 'inlinepopups, paste, searchreplace, preview, fullscreen',
		...
		theme_advanced_buttons2 : 'cut, copy, paste, pastetext, pasteword, |, search, replace,|,undo,redo,|,preview, fullscreen',
